...
def build_SV_GAP(learning_rate=0.001):
  input_shape = (32, 32, 3)
  outputs = 9
  model = Sequential([
...
train_model(model=build_SV_GAP(learning_rate=0.001), name='SV_GAP_LR0.001', image_size=32, early_stopping_min=30, epochs_min=120,path='SV_GAP')
